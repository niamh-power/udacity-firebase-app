...
/**
 * An activity representing a single Menu Item detail screen. This
 * activity is only used on narrow width devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a [MenuItemListActivity].
 */
class MenuItemDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(MenuItemDetailFragment.ARG_ITEM_ID,
                    intent.getStringExtra(MenuItemDetailFragment.ARG_ITEM_ID))
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(Intent(this, MenuItemListActivity::class.java))
            return true
        }
